...
internal static class NativeConstants
{
    ...
    public const uint SandboxWindowStationAccess =
        WINSTA_ENUMDESKTOPS | WINSTA_READATTRIBUTES | WINSTA_WRITEATTRIBUTES | WINSTA_ENUMERATE |
        WINSTA_ACCESSGLOBALATOMS | STANDARD_RIGHTS_READ | READ_CONTROL;
    public const uint SandboxDesktopAccess =
        DESKTOP_READOBJECTS | DESKTOP_CREATEWINDOW | DESKTOP_CREATEMENU | DESKTOP_ENUMERATE |
        DESKTOP_WRITEOBJECTS | STANDARD_RIGHTS_READ | READ_CONTROL;
