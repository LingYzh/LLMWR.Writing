...
[JsonSerializable(typeof(IpcEnvelope<DeactivateExtensionRequest>), TypeInfoPropertyName = "DeactivateExtensionRequestEnvelope")]
[JsonSerializable(typeof(IpcEnvelope<DeactivateExtensionResponse>), TypeInfoPropertyName = "DeactivateExtensionResponseEnvelope")]
[JsonSerializable(typeof(IpcEnvelope<TrustProjectExtensionsRequest>), TypeInfoPropertyName = "TrustProjectExtensionsRequestEnvelope")]
[JsonSerializable(typeof(IpcEnvelope<TrustProjectExtensionsResponse>), TypeInfoPropertyName = "TrustProjectExtensionsResponseEnvelope")]
[JsonSerializable(typeof(IpcEnvelope<RevokeProjectExtensionsTrustRequest>), TypeInfoPropertyName = "RevokeProjectExtensionsTrustRequestEnvelope")]
[JsonSerializable(typeof(IpcEnvelope<RevokeProjectExtensionsTrustResponse>), TypeInfoPropertyName = "RevokeProjectExtensionsTrustResponseEnvelope")]
[JsonSerializable(typeof(IpcEnvelope<ListExtensionsRequest>), TypeInfoPropertyName = "ListExtensionsRequestEnvelope")]
[JsonSerializable(typeof(IpcEnvelope<ListExtensionsResponse>), TypeInfoPropertyName = "ListExtensionsResponseEnvelope")]
